  ...
  return (
    <div>
      <div className="relative">
        ...
        {leftDays > 0 ? (
          <div className="trasform -translate-y-5 md:translate-y-20 xl:translate-y-10 absolute top-1/3 right-1/16 xl:right-2/16 py-2 px-3 text-xl md:text-2xl xl:text-3xl text-secondary text-right tiny:text-left w-2/3 tiny:w-max">
